...
var squish = new sound("sound/squish.mp3");
var gameOver = new sound("sound/gameOver.wav");
var gameWin = new sound("sound/gameWin.wav");
var getKey = new sound("sound/getKey.wav");
var door = new sound("sound/door.mp3");
...
function toggleAudio() {
  ...
  document.getElementById("audioButton").innerHTML = (document.getElementById("audioButton").innerHTML == "Music: On") ? "Music: Off" : "Music: On";
